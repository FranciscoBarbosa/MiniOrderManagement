...
class OrderResponseMapperTest {
    ...
    void shouldMapFromOrderRequestToDomain(){
        ...
        assertThat(areOrderlinesEqual(orderlineList.get(0), orderResponseDto.orderlineList().get(0))).isTrue();
        assertThat(areOrderlinesEqual(orderlineList.get(1), orderResponseDto.orderlineList().get(1))).isTrue();
    }

    private boolean areOrderlinesEqual(Orderline orderline, OrderlineResponseDto orderlineResponseDto){
